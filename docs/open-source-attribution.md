...
Review date: 2026-09-03. Versions are locked by `pubspec.yaml` and `pubspec.lock`; bundled license texts in resolved packages remain the legal source of truth.
