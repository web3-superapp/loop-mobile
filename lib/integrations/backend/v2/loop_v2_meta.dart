...
/// `notificationsFeed` by the step-5 market and alerts modules. The parser
/// requires the exact set, so this list must track the frozen contract even for
/// modules this step does not consume.
